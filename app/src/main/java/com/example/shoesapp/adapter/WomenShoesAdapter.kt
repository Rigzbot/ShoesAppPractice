...
import com.example.shoesapp.WomenFragment
import com.example.shoesapp.model.Shoes

class WomenShoesAdapter(
    private val context: WomenFragment,
    private val dataset: List<Shoes>
) : RecyclerView.Adapter<WomenShoesAdapter.ItemViewHolder>() {
